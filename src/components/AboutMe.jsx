...
const AboutMe = () => {
  return (
    <div className="h-auto w-[90%] md:w-[80%] bg-zinc-900 border-gray-400 border self-center rounded-xl">
      <p className=" text-white font-VarelaRound text-4xl p-5 text-center"></p>
      <div className="flex flex-col  ">
        <img src="/MyPhoto.jpg" className="  w-52 self-center rounded-full" />

        <p className="text-white text-center p-5 font-VarelaRound font-bold  md:p-20 md:text-4xl">
